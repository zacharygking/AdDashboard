...
urlpatterns = [
    ...
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/1/$', views.collect1, name='collect1'), 
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/1/2/$', views.collect2, name='collect2'), 
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/1/2/3/$', views.collect3, name='collect3'),
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/1/2/3/4/$', views.collect4, name='collect4'),
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/1/2/3/4/5/$', views.collect5, name='collect5'),  
