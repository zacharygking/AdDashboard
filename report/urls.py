...
urlpatterns = [
    ...
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/2/$', views.collect2, name='collect2'), 
    url(r'^generate/(?P<start_date>[-A-Za-z0-9_]+)/(?P<end_date>[-A-Za-z0-9_]+)/(?P<gcid>[0-9]+)/(?P<fcid>[0-9]+)/3/$', views.collect3, name='collect3'), 
